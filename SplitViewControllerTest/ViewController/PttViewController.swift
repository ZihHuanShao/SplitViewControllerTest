...
extension PttViewController {
    ...
    private func tabLeftContentButtonPressedHandler() {
        ...
        tableViewDelegate = PttViewControllerTableViewDelegate(pttViewController: self, tableView: tableView, type: .GROUP)
    ...
    private func tabRightContentButtonPressedHandler() {
        ...
        tableViewDelegate = nil
        tableViewDelegate = PttViewControllerTableViewDelegate(pttViewController: self, tableView: tableView, type: .MEMBER)
...
extension PttViewController: UITextFieldDelegate {
