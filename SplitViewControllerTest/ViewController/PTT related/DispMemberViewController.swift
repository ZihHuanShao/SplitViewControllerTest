//
//  DispMemberViewController.swift
...
class DispMemberViewController: UIViewController {
    ...
    // tableview
    fileprivate var tableViewDelegate: DispMemberViewControllerTableViewDelegate?
...
extension DispMemberViewController {
    ...
    func updateUI() {
        ...
        tableViewDelegate = DispMemberViewControllerTableViewDelegate(dispMemberViewController: self, tableView: tableView)
        tableViewDelegate?.registerCell(cellName: DISP_MEMBER_PROFILE_TABLE_VIEW_CELL, cellId: DISP_MEMBER_PROFILE_TABLE_VIEW_CELL)
