...
// MARK: - Public Methods
extension DispGroupViewController {
...
extension DispGroupViewController {
    private func updateDataSource() {
        collectionViewDelegate = DispGroupViewControllerCollectionoViewDelegate(dispGroupViewController: self, collectionView: collectionView)
        
        groupSettingInfTableViewDelegate = DispGroupViewControllerGroupSettingInfoTableViewDelegate(dispGroupViewController: self, tableView: groupSettingInfoTableView)
    }
    ...
    private func updateUI() {
        ...
        groupSettingInfTableViewDelegate?.registerCell(cellName: DISP_GROUP_SETTING_INFO_TABLE_VIEW_CELL, cellId: DISP_GROUP_SETTING_INFO_TABLE_VIEW_CELL)
...
extension DispGroupViewController: GroupViewControllerCollectionoViewDelegateExtend {
