//
//  dp_CreateGroupViewController.swift
...
class dp_CreateGroupViewController: UIViewController {
...
extension dp_CreateGroupViewController {
    ...
    private func updateUI() {
        ...
        tableViewDelegate = dp_CreateGroupViewControllerTableViewDelegate(dp_createGroupViewController: self, tableView: tableView)
        tableViewDelegate?.registerCell(cellName: DP_CREATE_GROUP_TABLE_VIEW_CELL, cellId: DP_CREATE_GROUP_TABLE_VIEW_CELL)
...
extension dp_CreateGroupViewController: UITextFieldDelegate {
