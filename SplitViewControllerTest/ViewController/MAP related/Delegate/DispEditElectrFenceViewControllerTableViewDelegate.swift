//
//  DispEditElectrFenceViewControllerTableViewDelegate.swift
...
class DispEditElectrFenceViewControllerTableViewDelegate: NSObject {
    
    // MARK: - Properties
    
    fileprivate weak var viewController: DispEditElectrFenceViewController?
    ...
    init(dispEditElectrFenceViewController: DispEditElectrFenceViewController, tableView: UITableView) {
        super.init()
        self.viewController = dispEditElectrFenceViewController
...
extension DispEditElectrFenceViewControllerTableViewDelegate: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: DISP_EDIT_ELECTR_FENCE_TABLE_VIEW_CELL, for: indexPath) as! DispEditElectrFenceTableViewCell
...
extension DispEditElectrFenceViewControllerTableViewDelegate: UITableViewDelegate {
    /*
