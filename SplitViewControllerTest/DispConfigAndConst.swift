...
let UPDATE_EXIST_ELECTR_FENCE_VO_NOTIFY_KEY = NSNotification.Name("updateExistElectrFenceVoNotifyKey")
...
let UPDATE_EXIST_ELECTR_FENCE_VO_USER_KEY = "updateExistElectrFenceVoUserKey"
