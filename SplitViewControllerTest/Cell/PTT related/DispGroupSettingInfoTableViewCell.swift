//
//  DispGroupSettingInfoTableViewCell.swift
...
class DispGroupSettingInfoTableViewCell: UITableViewCell {
...
extension DispGroupSettingInfoTableViewCell {
    ...
    func updateCell(_ type: GroupSettingType) {
        ...
        case .MONITOR_MODE:
            ...
            itemTitle.text = str_dispGroup_monitorMode
            itemDesc.text = str_dispGroup_monitorModeDesc
        ...
        case .EDIT_GROUP:
            ...
            itemTitle.text = str_dispGroup_editGroup
            itemDesc.text = str_dispGroup_editGroupDesc
